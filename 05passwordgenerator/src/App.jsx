  ...
  return (
    <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 bg-gray-800 text-orange-500'>
        ...
        <div className='flex shadow rounded-lg overflow-hidden mb-4'>
          ...
          <button className='outline-none bg-blue-700 text-white px-3 py-0.5 shirnk-0'>Copy</button>
        </div>
        <div className='flex items-center gap-x-1'>
         ...
         <div className='flex items-center gap-x-1'>
          <input type="checkbox" defaultChecked={numberAllowed} onChange={(e)=>{setNumberAllowed(!e.target.value)}} />{/* This is a single-line comment within JSX */}
        </div>
    </div>
  )
}
